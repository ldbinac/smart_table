...
更疯狂的是，我决定**全程使用 AI 辅助编码**来完成这个项目。尽量减少人工编码的介入（99%的代码都是AI生成的）。
...
| 功能    | 预览                              | 功能    | 预览                                  |
| ----- | ------------------------------- | ----- | ----------------------------------- |
| 首页    | ![首页](../doc/home.jpeg)         | 全部多维表 | ![首页2](../doc/home-all.jpeg)        |
| 表格视图  | ![表格视图](../doc/TableView.jpeg)  | 表格分组  | ![表格视图](../doc/TableViewGroup.jpeg) |
| 看板视图  | ![看板视图](../doc/KanbanView.jpeg) | 日历视图  | ![日历视图](../doc/CalendarView.jpeg)   |
| 甘特图视图 | ![甘特图视图](../doc/GanttView.jpeg) | 表单视图  | ![表单视图](../doc/FormView.jpeg)       |
| 表单配置  | ![表单视图](../doc/FormView.jpeg)   | 仪表盘   | ![仪表盘](../doc/Dashboard.jpeg)       |
